...
update turmas set sala = 301 where cod_da_disciplina = 50;
update turmas set sala = 302 where cod_da_disciplina = 51;

select * from professor;

insert into professor values ('pedro',1,45821784);
insert into professor values ('alien',4,47218024);

update professor set unidade = 1 where unidade = 'pedro';